...
/**
 * A {@link IModule module}, which injects Log4J 2 loggers, aka instances of
 * {@link Logger}.
 ...
 */
public class Log4j2LoggerModule extends AbstractLoggerInjectingModule<Logger> {
	/**
	 * Creates an instance of {@link Logger}.
	 */
	@Override
	protected Logger newLogger(String pId) {
		return LogManager.getLogger(pId);
	}
}
